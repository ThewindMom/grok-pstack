...
- `read_file` calls against any `SKILL.md` file (workspace `.grok/skills/`, user-level `~/.grok/skills/`, or plugin-installed paths)
- `spawn_subagent` prompts that name a skill path
