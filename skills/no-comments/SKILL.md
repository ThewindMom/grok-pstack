...
The parent session owns the spawn. Comment Sicko is a leaf. See the keel skill `references/spawn.md`.
...
1. Call `spawn_subagent` with `subagent_type: "comment-sicko"`, `capability_mode: "read-only"`. Pass the scope. Do not restate its rules.
