...
Transcripts live where the Grok session says they live. Try `~/.grok/sessions/` and project `.grok/transcripts/`. Do not glob `~/.cursor/projects/*/`. That crosses workspace boundaries.
